  ...
  const mapRegisterErrorToField = (payload: AuthApiPayload | null) => {
    ...
    switch (payload?.code) {
      case "INVALID_EMAIL_DOMAIN":
        return {
          email:
            backendMessage || "This email domain does not exist. Check your email address",
        };
      case "EMAIL_ALREADY_USED":
        return {
          email: backendMessage || "An account already exists with this email address",
        };
      default:
        if (
        ...
        return backendMessage ? { general: backendMessage } : {};
    }
  };
